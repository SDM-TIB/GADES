...
class MyOWLOntology():
    def __init__(self, ont_file, pr: str=None):
        ...
        # ---------generate graph files for METIS-----------
        patients = [
        ...
        sim_mat = similarity_calculation(patients, c_trials)
        save_sim_mat(sim_mat)
        sim_mat = read_sim_mat()
        sim_mat_to_graph(sim_mat)
        # ---------generate graph files for METIS-----------
        ...
        # ]
        utils.generate_bigraph(patients, c_trials, edges, outdir='/mnt/c/Users/SongZ/Downloads/repositories/pyGADES/results/')
        community_dir = '/mnt/c/Users/SongZ/Downloads/repositories/pyGADES/results/bigraph-0.6000-0.6000-Clusters'
        # ---------generate graph files for semEP-----------
